...
| `garden.html` | **Game** (`v0.1`) — a zen stone-garden Sokoban: twelve hand-made, machine-verified-solvable levels of nudging stones onto moss beds. Unlimited undo, no clock, no move-count records, no level locks. On-device only, outside sync + usage like Echo. State: `hill-climbing-garden`. | If relevant |
