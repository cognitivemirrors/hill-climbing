...
### L34. Savor's seed "community" lessons are authored, not contributed — and its progression is lighter than Nourish's but still present
- **Confidence:** confirmed (design consideration, not a bug)
- **Where:** `savor.html`, added v0.1.
...
### L35. Savor ⇄ Nourish integration couples two files on a schema and an id contract
