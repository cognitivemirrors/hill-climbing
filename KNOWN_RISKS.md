...
### L32. Companion now persists a cross-conversation memory — the first at-rest personal *summary*, and a break from the "for this conversation only" framing (v0.6, founder-requested)
- **Confidence:** confirmed (by design; `companion.html` v0.6 · companion — founder request: "context about me shouldn't be lost across conversations")
